...
const int missingSourceTimeout = 200;  // Timeout for pulseIn()
...
void setup() {
  ...
  timer.attach_ms(inactivePeriod / 1000.0, blinkLED);
...
void transmitString(String input) {
  ...
  Serial.println("");
  timer.attach_ms(inactivePeriod / 1000.0, blinkLED); // Restore the original timer period
}
