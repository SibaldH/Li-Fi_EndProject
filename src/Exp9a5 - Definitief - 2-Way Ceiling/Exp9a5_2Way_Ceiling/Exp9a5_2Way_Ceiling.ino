/*
  ...
  This code is designed for the ceiling, sending 1000 & 1200 Hz, receiving 600 & 800 Hz.
...
const int frequencyOut0 = 1000;               // Transmitting frequency for bit 0
const int frequencyOut1 = 1200;               // Transmitting frequency for bit 1
